...
$data=Data::QueryData("forum_post","","uid='$uid'","posttime desc","$minid,$pagenum");
...
if($_GET["do"]=="del"){
    ...
    if(Data::DelData("forum_post","uid='$uid' and id='$id'")):
        Inc::GoUrl(Route::Link("forum","my_post_list"),"删除成功!");
    else:
        Inc::GoUrl("-1","删除失败!");
    endif;
}